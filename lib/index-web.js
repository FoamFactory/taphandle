(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.taphandle = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports["default"] = toggleFieldMask;
 ...
 */
function toggleFieldMask(field, mask) {
...
},{"./toggle-field-mask":1,"resolve-id-refs":27}],3:[function(require,module,exports){
"use strict";
...
var Behavior = /*#__PURE__*/function (_behavior) {
  ...
  function Behavior(events, properties) {
    ...
    return _super.call(this, events, Object.assign({
...
},{"receptor":25}],4:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.PasswordRevealIndicator = void 0;

var _behavior = require("../behavior");

var _toggleFormInput = _interopRequireDefault(require("../actions/toggle-form-input"));
...
var PasswordRevealIndicator = /*#__PURE__*/function (_Behavior) {
  _inherits(PasswordRevealIndicator, _Behavior);

  var _super = _createSuper(PasswordRevealIndicator);

  function PasswordRevealIndicator(prefix, options) {
    _classCallCheck(this, PasswordRevealIndicator);

    var selector = ".".concat(prefix, "_show-password, .").concat(prefix, "_show-multipassword");

    var clickedMethod = function clickedMethod(event) {
      PasswordRevealIndicator.clicked(event);
    };

    return _super.call(this, _defineProperty({}, 'click', _defineProperty({}, selector, clickedMethod)));
  }

  _createClass(PasswordRevealIndicator, null, [{
    key: "clicked",
    value: function clicked(event) {
      event.preventDefault();
      (0, _toggleFormInput["default"])(event.target);
    }
  }]);

  return PasswordRevealIndicator;
}(_behavior.Behavior);

exports.PasswordRevealIndicator = PasswordRevealIndicator;
},{"../actions/toggle-form-input":2,"../behavior":3}],5:[function(require,module,exports){
"use strict";
...
},{"../../":11,"../../behavior":3,"jquery":17}],6:[function(require,module,exports){
"use strict";
...
var FullNameValidator = /*#__PURE__*/function (_FieldValidator) {
  ...
  _createClass(FullNameValidator, null, [{
    ...
    key: "doesElementMatchSelector",
    value: function doesElementMatchSelector(element) {
      var selector = FullNameValidator.getSelector();
    ...
    value: function setElementInvalid(element, message) {
      ...
      FullNameValidator.setOrClearValidityMessage(message, element, messageElement);
    }
    /**
     * Clear a previously set manual invalidation message.
     *
    ...
    value: function clearElementInvalid(element) {
      ...
      FullNameValidator.setOrClearValidityMessage(true, element, messageElement);
    }
  }]);
...
},{"../../behavior":3,"./field-validator":5,"jquery":17}],7:[function(require,module,exports){
"use strict";
...
var GenericTextValidator = /*#__PURE__*/function (_FieldValidator) {
  ...
  _createClass(GenericTextValidator, null, [{
    ...
    key: "doesElementMatchSelector",
    value: function doesElementMatchSelector(element) {
      var selector = GenericTextValidator.getSelector();
    ...
    value: function setElementInvalid(element, message) {
      ...
      GenericTextValidator.setOrClearValidityMessage(message, element, messageElement);
    }
  }, {
    key: "clearElementInvalid",
    value: function clearElementInvalid(element) {
      ...
      GenericTextValidator.setOrClearValidityMessage(true, element, messageElement);
    }
  }]);
...
},{"../../behavior":3,"./field-validator":5,"jquery":17}],8:[function(require,module,exports){
"use strict";
...
},{"../../behavior":3,"./field-validator":5,"./password-validator":9,"jquery":17}],9:[function(require,module,exports){
"use strict";
...
},{"./field-validator":5,"./password-confirmation-validator":8,"jquery":17}],10:[function(require,module,exports){
"use strict";
...
var UsernameValidator = /*#__PURE__*/function (_FieldValidator) {
  _inherits(UsernameValidator, _FieldValidator);

  var _super = _createSuper(UsernameValidator);

  function UsernameValidator(prefix, options) {
    _classCallCheck(this, UsernameValidator);

    return _super.call(this, prefix, 'text', "".concat(prefix, "_usernameField"), options);
  }

  _createClass(UsernameValidator, null, [{
    key: "validate",
    value: function validate(element) {
      var requiredValuePresent = _get(_getPrototypeOf(UsernameValidator), "validate", this).call(this, element);
    ...
    value: function setOrClearValidityMessage(validityMessage, element, messageElement) {
      if (validityMessage !== true) {
        ...
        _fieldValidator.FieldValidator.enableErrorMessage(element, messageElement, UsernameValidator, message);
      } else {
        _fieldValidator.FieldValidator.disableErrorMessage(element, messageElement, UsernameValidator);
      }
    }
  }, {
    key: "getSelector",
    value: function getSelector() {
      return ['text', "".concat(_fieldValidator.FieldValidator._prefix, "_usernameField")];
    }
    /**
     * Determine if an element matches the CSS selector for this
     * {FieldValidator}.
    ...
    key: "doesElementMatchSelector",
    value: function doesElementMatchSelector(element) {
      var selector = UsernameValidator.getSelector();
    ...
    value: function setElementInvalid(element, message) {
      ...
      UsernameValidator.setOrClearValidityMessage(message, element, messageElement);
    }
    /**
     * Clear a previously set manual invalidation message.
     *
...
_defineProperty(UsernameValidator, "_defaultValueMissingMessage", 'Please enter a username');
},{"../../behavior":3,"./field-validator":5,"jquery":17}],11:[function(require,module,exports){
"use strict";
...
},{"./components/password-reveal-indicator":4,"./components/validation/field-validator":5,"./components/validation/full-name-validator":6,"./components/validation/generic-text-validator":7,"./components/validation/password-confirmation-validator":8,"./components/validation/password-validator":9,"./components/validation/username-validator":10,"./utils":12}],12:[function(require,module,exports){
"use strict";
...
},{"@foamfactory/paulrevere":15,"jquery":17}],14:[function(require,module,exports){
"use strict";
...
Object.defineProperty(exports, "ComponentBehaviors", {
  enumerable: true,
  get: function get() {
    return _behavior.ComponentBehaviors;
  }
});

var _ErrorHandler = require("./exceptions/ErrorHandler");

var _behavior = require("./behavior");
},{"./behavior":11,"./exceptions/ErrorHandler":13}],15:[function(require,module,exports){
"use strict";
 ...
 */
var PaulRevere = /*#__PURE__*/function () {
...
},{"../delegate":22,"../delegateAll":23,"object-assign":19}],21:[function(require,module,exports){
...
},{"element-closest":16}],23:[function(require,module,exports){
const delegate = require('../delegate');
...
},{"../compose":21,"../delegate":22}],24:[function(require,module,exports){
...
},{"./behavior":20,"./delegate":22,"./delegateAll":23,"./ignore":24,"./keymap":26}],26:[function(require,module,exports){
...
},{"keyboardevent-key-polyfill":18}],27:[function(require,module,exports){
'use strict';
