...
},{"../behavior":3,"jquery":15}],5:[function(require,module,exports){
"use strict";
    ...
    value: function validate(element, messageElement) {
      ...
      if (element.validity.valueMissing) {
        if (messageElement.text().length === 0) {
          messageElement.text(_password.Password._defaultValueMissingMessage);
        }

        (0, _jquery["default"])(element).addClass(_password.Password._fieldMessageErrorClass);
        (0, _jquery["default"])(messageElement).css('visibility', 'visible');
      } else if (!requiredMatchValid) {
        (0, _jquery["default"])(element).addClass(_password.Password._fieldMessageErrorClass);
        (0, _jquery["default"])(messageElement).text(_password.Password._defaultMatchFailedMessage);
        (0, _jquery["default"])(messageElement).css('visibility', 'visible');
      } else {
        (0, _jquery["default"])(element).removeClass(_password.Password._fieldMessageErrorClass);
...
},{"../behavior":3,"./field-validator":4,"./password":7,"jquery":15}],6:[function(require,module,exports){
"use strict";
...
function toggle(event) {
  ...
  (0, _toggleFormInput["default"])(this);
}
...
var PasswordRevealIndicator = /*#__PURE__*/function (_Behavior) {
  ...
  function PasswordRevealIndicator(prefix, options) {
    ...
    var LINK = ".".concat(prefix, "_show-password, .").concat(prefix, "_show-multipassword");
    return _super.call(this, _defineProperty({}, 'click', _defineProperty({}, LINK, toggle)));
  }
...
},{"../actions/toggle-form-input":2,"../behavior":3}],7:[function(require,module,exports){
"use strict";
...
var Password = /*#__PURE__*/function (_FieldValidator) {
  ...
  function Password(prefix, options) {
    ...
    return _super.call(this, prefix, "".concat(prefix, "_passwordField"), options);
  }
  ...
  _createClass(Password, null, [{
    ...
    value: function validate(element, messageElement) {
      ...
      if (element.validity.valueMissing) {
        ...
        (0, _jquery["default"])(element).addClass(Password._fieldMessageErrorClass);
        (0, _jquery["default"])(messageElement).css('visibility', 'visible');
      } else if (!requiredMatchValid) {
        (0, _jquery["default"])(element).addClass(Password._fieldMessageErrorClass);
        (0, _jquery["default"])(messageElement).text(Password._defaultMatchFailedMessage);
        (0, _jquery["default"])(messageElement).css('visibility', 'visible');
      } else {
        (0, _jquery["default"])(element).removeClass(Password._fieldMessageErrorClass);
        (0, _jquery["default"])(messageElement).css('visibility', 'hidden');
      }
    }
  }, {
...
},{"../behavior":3,"./field-validator":4,"jquery":15}],8:[function(require,module,exports){
"use strict";
...
var Username = /*#__PURE__*/function (_FieldValidator) {
  ...
  function Username(prefix, options) {
    ...
    return _super.call(this, prefix, "".concat(prefix, "_usernameField"), options);
  }
  ...
  _createClass(Username, null, [{
    ...
    value: function validate(element, messageElement) {
      if (element.validity.valueMissing) {
        ...
        (0, _jquery["default"])(element).addClass(Username._fieldMessageErrorClass);
        (0, _jquery["default"])(messageElement).css('visibility', 'visible');
      } else {
        (0, _jquery["default"])(element).removeClass(Username._fieldMessageErrorClass);
        (0, _jquery["default"])(messageElement).css('visibility', 'hidden');
      }
    }
  }]);
...
},{"../behavior":3,"./field-validator":4,"jquery":15}],9:[function(require,module,exports){
"use strict";
...
},{"./components/password":7,"./components/password-confirmation":5,"./components/password-reveal-indicator":6,"./components/username":8}],10:[function(require,module,exports){
"use strict";
...
},{"@foamfactory/paulrevere":13,"jquery":15}],11:[function(require,module,exports){
"use strict";
...
Object.defineProperty(exports, "FieldValidator", {
  enumerable: true,
  get: function get() {
    return _FieldValidator.FieldValidator;
  }
});
...
var _FieldValidator = require("./validation/FieldValidator");

var _behavior = require("./behavior");
},{"./behavior":9,"./exceptions/ErrorHandler":10,"./validation/FieldValidator":12}],12:[function(require,module,exports){
"use strict";
