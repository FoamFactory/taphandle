...
var FieldValidator = /*#__PURE__*/function (_Behavior) {
  ...
  _createClass(FieldValidator, null, [{
    ...
    value: function removeAllErrors(className) {
      ...
      (0, _jquery["default"])(".".concat(className)).each(function () {
        var skipAVFlag = (0, _jquery["default"])(_this).data('skipautovalidation');
        ...
        if (!skipAVFlag) {
          ...
          var messageElement = (0, _jquery["default"])(_this).siblings(ffSelector);
          (0, _jquery["default"])(messageElement).css('visibility', 'hidden');
          (0, _jquery["default"])(_this).removeClass(FieldValidator._fieldMessageErrorClass);
        }
      });
    }
  }, {
    ...
    value: function changed(event, delegateClass) {
      ...
      var skipAVFlag = (0, _jquery["default"])(this).data('skipautovalidation');
